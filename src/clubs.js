...
// basePotentialSpeed calibration: 100% power with an ideal backswing equals
...
export const clubs = {
    ...
    'I3': { name: '3 Iron',         type: 'iron', loft: 20,   lengthFactor: 0.88, baseSmash: 1.46, baseAoA: -2.5, spinRateFactor: 0.88, basePotentialSpeed: 98.0, optimalSpin: 4300, defaultBallPositionIndex: 6, liftFactor: 7.5, clBackspinEff: 0.019 }, // Center-Forward
    'I4': { name: '4 Iron',         type: 'iron', loft: 22,   lengthFactor: 0.86, baseSmash: 1.44, baseAoA: -3,   spinRateFactor: 0.92, basePotentialSpeed: 96.0, optimalSpin: 4800, defaultBallPositionIndex: 6, liftFactor: 6.0, clBackspinEff: 0.017 }, // Center-Forward
    'I5': { name: '5 Iron',         type: 'iron', loft: 25,   lengthFactor: 0.84, baseSmash: 1.41, baseAoA: -3.5, spinRateFactor: 0.96, basePotentialSpeed: 94.0, optimalSpin: 5300, defaultBallPositionIndex: 6, liftFactor: 4.5, clBackspinEff: 0.016}, // Center-Forward
    'I6': { name: '6 Iron',         type: 'iron', loft: 28, lengthFactor: 0.82, baseSmash: 1.38, baseAoA: -4,   spinRateFactor: 1.0, basePotentialSpeed: 92.0, optimalSpin: 6000, defaultBallPositionIndex: 5, liftFactor: 2.0, clBackspinEff: 0.0155}, // Center-Fwd
    'I7': { name: '7 Iron',         type: 'iron', loft: 32,   lengthFactor: 0.8,  baseSmash: 1.34, baseAoA: -4.5, spinRateFactor: 1.05, basePotentialSpeed: 90.0, optimalSpin: 7000, defaultBallPositionIndex: 5, liftFactor: 1.0, clBackspinEff: 0.013 }, // Center-Fwd
    'I8': { name: '8 Iron',         type: 'iron', loft: 36,   lengthFactor: 0.78, baseSmash: 1.30, baseAoA: -5,   spinRateFactor: 1.1, basePotentialSpeed: 87.5, optimalSpin: 7800, defaultBallPositionIndex: 5, liftFactor: 1.0, clBackspinEff: 0.012 }, // Center-Fwd
    'I9': { name: '9 Iron',         type: 'iron', loft: 40,   lengthFactor: 0.76, baseSmash: 1.26, baseAoA: -5.5, spinRateFactor: 1.15, basePotentialSpeed: 85.0, optimalSpin: 8600, defaultBallPositionIndex: 4, liftFactor: 1.0, clBackspinEff: 0.011 }, // Center-Back
    // Wedges - Added liftFactor and type
    'PW': { name: 'Pitching Wedge', type: 'wedge', loft: 45,   lengthFactor: 0.74, baseSmash: 1.23, baseAoA: -5.8, spinRateFactor: 1.2, basePotentialSpeed: 83.0, optimalSpin: 9200, defaultBallPositionIndex: 4, liftFactor: 0.9, clBackspinEff: 0.009 }, // Center-Back
