...
// Pure XZ-plane point-in-polygon, moved to ./pointInPolygon.js so modules
// that need it can be loaded without THREE. Re-exported for existing callers.
export { isPointInPolygon } from './pointInPolygon.js';
